...
public class TampilSemuaPgw extends AppCompatActivity
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... params){
                ...
                Log.d("CLOG",konfigurasi.URL_GET_ALL);
                String s = rh.sendGetRequest(
    ...
    private void showEmployee(){
        ...
        try {
            ...
            for(int i = 0; i<result.length(); i++){
                ...
                String id = jo.getString(
                        konfigurasi.TAG_ID);
                String name = jo.getString(
    ...
    public void onItemClick(AdapterView<?> parent,
        ...
        String empId = map.get(konfigurasi.KEY_EMP_ID).toString();
        intent.putExtra(konfigurasi.KEY_EMP_ID,empId);
